                                ...
                                <?php
                                    $people = [
                                        [
                                            ...
                                            "contact_text" => "<i class=\"fal fa-envelope\"></i>",
                                            "banned" => "0"
                                        ],
                                        [
                                    ...
                                    foreach($people as $person)
                                    {
                                        ...
                                        <a href=\"".$person['twitter_link']."\" class=\"text-info fs-sm\" target=\"_blank\">".$twitter_name."</a> -
                                        <a href=\"".$person['contact_link']."\" class=\"text-info fs-sm\" target=\"_blank\" title=\"Contact ".$short_name."\">".$person['contact_text']."</a>
                                        </div></div>";
                                    }
                                ?>
                            </div>
