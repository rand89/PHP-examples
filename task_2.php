                            ...
                            <?php
                                $list_items = [
                                    ...
                                    "text" => "Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
                                        We will only use your personal information to administer your account, provide the products and services you have requested from us,
                                        and to keep you informed about our products and services (if you have consented to this).
                                    ...
                                    "text" => "We collect certain data through cookies and similar technologies (e.g. web beacons, tags, device identifiers).
                                        ...
                                        We register your interaction with our services in order to improve our website, content and services.
                                ...
                                foreach($list_items as $item)
                                {
                                    if($first) 
                                    {
                                        echo "<h2>".$item['title']."</h2><p class='mb-g'>".$item['text']."</p>";
                                        $first = false;
                                    }
                                    else echo "<h3>".$item['title']."</h3><p>".$item['text']."</p>";
                                }
                            ?>
                        </div>
                        </div>
